...
public class PessoaTest {
    ...
    void quando_cpf_tiver_11_digitos_da_certo(){
        Pessoa pessoaMock = new Pessoa("Guilherme", 2005,"123453","email@gmail.com","11912345678","11111111111");
        Assertions.assertEquals("11111111111", pessoaMock.isCpfValido());
    }
    @Test
    void quando_cpf_nao_tiver_11_digitos_throw_exception(){
        Pessoa pessoaMock = new Pessoa("Guilherme", 2005,"123453","email@gmail.com","11912345678","1");
    ...
    void quando_idade_menor_que_18_throws_runtime(){
        Assertions.assertThrows(RuntimeException.class, () -> {
            new Pessoa("Guilherme", 2010,"123453","email@gmail.com","11912345678","11111111111");
        });
    }

    @Test
    void quando_idade_maior_que_18_return_true(){
        Pessoa pessoaMock = new Pessoa("Guilherme", 1990,"123453","email@gmail.com","11912345678","11111111111");
